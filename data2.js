var mediaData = {
    ...
    audioFiles: [{
        ...
        fileName: ["cs2.mp3"],
        titles: ["章节前言 导入学习目的 明确学习目标", "2.1介绍数字系统 提出位置数字系统这个重点", "2.2位置数字系统的介绍及相关基本概念", " 2.2.1 第一个位置数字系统：十进制系统", "2.2.2 第二个位置数字系统：二进制系统", "十六进制和八进制"],
        time: [
            [0, 572],
            [573, 1093],
            [1094, 1592],
